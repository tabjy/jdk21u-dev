...
public class PowDNodeTests {
    ...
    private static void testCorrectness() {
        ...
        double[] values = {
                ...
                RNG.nextDouble(), RNG.nextDouble(), // uniforms
                RNG.nextDouble((double) Long.MAX_VALUE, Double.MAX_VALUE), -RNG.nextDouble((double) Long.MAX_VALUE, Double.MAX_VALUE), // some sufficiently large magnitudes
                Double.longBitsToDouble(RNG.nextLong()), Double.longBitsToDouble(RNG.nextLong()), // any bits with potentially more NaN representation
                RNG.nextDouble(), RNG.nextDouble() // a healthy sprinkle of whatever else is possible
        };
